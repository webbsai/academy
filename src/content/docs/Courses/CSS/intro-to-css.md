...
You can add comments in CSS using /\* \_/. Comments are ignored by the browser and you can use them to document your code.
...
If you’re wondering which styles are applied where, we can make use of a 4-part decimal system that determines specificity by making use of weights. In this system:
...
<html>
	...
	<body>
		...
		<p>
			Hi everyone! I am a beginner at CSS, excited to show you what I have
			learned today.
		</p>
		<p>
			This paragraph has a blue background because I applied inline
			styling on it.
		</p>
		<p>
			This paragraph has a bigger size than the others through a style I
			imported from my styles.css file
		</p>
		<p>
			This is just a boring old tag that has internal CSS styling applied
			to it. At least it looks good!
		</p>
	</body>
</html>
```
